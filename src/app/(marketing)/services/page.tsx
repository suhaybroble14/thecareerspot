...
const services = [
  {
    ...
    description:
      "Weekly sessions focused on the skills that actually matter. CV overhauls, interview prep, personal branding, portfolio building. Each one is led by someone who knows what they're talking about and explains it without the jargon.",
    features: [
  ...
  },
  {
    ...
    description:
      "Panels, fireside chats, and community gatherings that bring people together. Hear from professionals who've been through the same challenges you're facing and build a network that means something beyond a LinkedIn connection.",
    features: [
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <AnimateIn delay={0.2}>
            <p className="text-cream/60 text-lg md:text-xl max-w-2xl mt-8 leading-relaxed">
              ...
              of people who get it, we&apos;ve got you.
            </p>
          </AnimateIn>
        </div>
      </section>
        ...
        >
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              >
                <div className={"natural" in service && service.natural ? "" : "aspect-[4/3] bg-forest relative overflow-hidden"}>
                  {"image" in service && service.image && "natural" in service && service.natural ? (
                    <Image src={service.image as string} alt={service.title} width={0} height={0} sizes="100vw" style={{ width: "100%", height: "auto" }} />
                  ) : "image" in service && service.image ? (
                    <Image src={service.image as string} alt={service.title} fill className="object-cover" />
                  ) : (
                    <>
      ...
      <section className="py-24 md:py-32 bg-blush">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <SectionHeading
            ...
            description="Our pricing is fair, transparent, and doesn't come with hidden barriers. Details coming soon. Register your interest below."
          />
          <AnimateIn delay={0.3}>
            <Link
              href="/contact"
